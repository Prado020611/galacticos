 ...
 * @author cecom-e1-pa
 */
public class Cocina_caliente extends javax.swing.JFrame {

    /**
     * Creates new form Cocina_caliente
     */
    public Cocina_caliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cocina_caliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cocina_caliente().setVisible(true);
            }
        });
    }
