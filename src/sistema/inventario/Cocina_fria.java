 ...
 * @author cecom-e1-pa
 */
public class Cocina_fria extends javax.swing.JFrame {

    /**
     * Creates new form Cocina_fria
     */
    public Cocina_fria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cocina_fria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cocina_fria().setVisible(true);
            }
        });
    }
