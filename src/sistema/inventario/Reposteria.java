 ...
 * @author cecom-e1-pa
 */
public class Reposteria extends javax.swing.JFrame {

    /**
     * Creates new form Reposteria
     */
    public Reposteria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reposteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reposteria().setVisible(true);
            }
        });
    }
